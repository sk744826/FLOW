    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="info">
                ...
                <a href="hackthon.html" class="btn">learm more</a>
            </div>
        </div>
...
<div class="heading">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="images/kunalkumar.jpg" alt="">
            <h3>ARIF HUSSAIN ANSARI</h3>
            <span>CA OF GEC WEST CHAMPARAN sp <b> (Head of CA)</b></span>
            <div class="share">
            <a href="#" class="fab fa-facebook-f"></a>
                <a href="#" class="fab fa-twitter"></a>
                <a href="https://www.instagram.com/arifhussainansarikujhwa/?utm_source=ig_web_button_share_sheet&igshid=OGQ5ZDc2ODk2ZA==" class="fab fa-instagram"></a>
        ...
        <div class="box">
            <img src="images/chandankumar.jpeg" alt="">
            <h3>chandan KUMAR</h3>
        ...
        <div class="box">
            <img src="images/kunal kumar.jpg" alt="">
            <h3>kunalkumar</h3>
            <span>CA OF GEC WEST CHAMPARAN </span>
            <div class="share">
            <a href="#" class="fab fa-facebook-f"></a>
        ...
        <div class="box">
            <img src="images/nitish kumar.jpeg" alt="">
            <h3>N KUMAR PASWAN</h3>
            <span>CA OF GEC WEST CHAMPARAN</span>
            <div class="share">
            <a href="#" class="fab fa-facebook-f"></a>
                <a href="#" class="fab fa-twitter"></a>
...
<section class="contact" id="contact">
    ...
    <form action="contact_form.php" method="post" class="contact-form">
        <div class="inputBox">
            ...
            <input type="text" placeholder="Roll number" name="Rollnumber">
            <!-- <input type="text" placeholder="Section" name="Section"> -->
            <input type="text" placeholder="year" name="year">
        </div>
        <div class="inputBox">
            
            <input type="number" placeholder="Moblie number" name="phone">
        ...
        <!-- <textarea placeholder="your Team Name " name="message" id="" cols="30" rows="10"></textarea> -->
        
        <input type="submit" value="Register" class="btn" name="send">
        <div class="Iheading">
            <div class="IITKGP">
            <a href="https://www.ktj.in/">Make sure you Register <b>(compulsory)</b> offical website IIT KGP (TAP and go Link) </a>
            </div>
...
<div class="footer"> created by <span>keneynicxkunal</span> | all rights reserved! </div>
